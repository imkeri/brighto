...
const ApiLog = ({ ApiLogData, apiPage, setApiPage, total, showOffCanvas, handleOffCanvas, fetchAPILog }) => {
    const { spin } = useContext(AuthContext);
    return (
        <>
            {spin && <Spin />}
            <div>
                <Admin open={showOffCanvas} handleOffCanvas={handleOffCanvas} fetchlistData={fetchAPILog} type={"Logs"} page={apiPage} setPage={setApiPage}/>
                                        ...
                                        <div class="w-11/12 flex justify-between flex-col md:flex-row gap-4 md:gap-8">
                                            ...
                                            <div class=" flex flex-col w-full gap-2">
                                                ...
                                                <div class="flex md:flex-col">
                                                    ...
                                                    <span class={`${value?.status_code === "200" ? "text-green-500" : "text-red-500"}`}>{value?.status_code}</span>
                                                </div>
                                            </div>
                                            <div class=" flex flex-col w-full gap-2">
                                                <div class="flex md:flex-col">
